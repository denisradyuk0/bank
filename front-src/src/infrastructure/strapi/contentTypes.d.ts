...
export interface ApiConfigConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rate_in: Schema.Attribute.Decimal;
    rate_out: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wallet_code: Schema.Attribute.String;
    wallet_qr: Schema.Attribute.Media<'images'>;
  };
}

export interface ApiDepositDeposit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deposit_id: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::deposit.deposit'
    ...
    publishedAt: Schema.Attribute.DateTime;
    state: Schema.Attribute.Enumeration<['pending', 'success']> &
...
export interface ApiPaymentMethodPaymentMethod
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expiration: Schema.Attribute.String;
    fullname: Schema.Attribute.String;
    limit: Schema.Attribute.Decimal & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    requests_per_day: Schema.Attribute.Integer;
    state: Schema.Attribute.Enumeration<['active', 'disabled', 'archived']> &
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    api_token: Schema.Attribute.String;
    ...
    token: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    traffic_enabled: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wallet_code: Schema.Attribute.String;
    wallets: Schema.Attribute.Relation<
      'oneToMany',
      'api::payment-method.payment-method'
    >;
  };
